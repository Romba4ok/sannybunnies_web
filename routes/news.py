...
def index():
    ...
    return render_template('news/news.html', items=items, section='Новости')


@news_bp.route('/add_form')
@login_required
def add_form():
    return render_template('news/add_news.html', section='Новости')
...
def edit(news_id):
    ...
    return render_template('news/edit_news.html', news=news_item, section='Новости')
